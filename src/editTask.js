...
export const editTask = function (taskId) {
  ...
  const displayEditTaskModal = function () {
    ...
    editTaskModal.querySelector("#task-priority").value =
      `${taskToEdit.priority}`;
    editTaskModal.querySelector("#parent-project").value =
      `${taskToEdit.parentProject}`;
  ...
  const edit = function () {
    ...
    taskToEdit.priority = modal.querySelector(
      "select[name='task-priority']",
    ).value;
    taskToEdit.parentProject = modal.querySelector(
